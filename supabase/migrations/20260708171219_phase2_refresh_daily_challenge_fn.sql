-- Congela el nº1 del leaderboard como rival del día. Si aún no hay
-- puntuaciones, deja al campeón de la casa (El Pirulas) como rival por
-- defecto para que el frontend siempre tenga un desafío que mostrar.
...
-- Solo el owner/service role puede refrescar: el desafío queda congelado
-- durante el día y nadie puede forzar su regeneración desde el cliente.
